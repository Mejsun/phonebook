  ...
  return (
    <>
      <Td data-heading="Name">
        <Info>{contact.contactName}</Info>
      </Td>
      <Td data-heading="Company">
        <Info>{contact.company}</Info>
      </Td>
      <Td data-heading="Email">
        <Info>{contact.primaryEmailAddress}</Info>
      </Td>
      <Td data-heading="Mobile">
        <Info>{contact.mobilephone}</Info>
      </Td>
      <Td data-heading="Home">
        <Info>{contact.homephone}</Info>
      </Td>
      <Td data-heading="Work">
        <Info>{contact.workphone}</Info>
      </Td>
